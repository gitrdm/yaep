...
static const yytype_uint8 yyrline[] =
{
     ...
     161,   162,   165,   165,   168,   169,   172,   192,   198,   208,
     211,   212,   213,   220,   227,   231,   237,   238,   244,   252,
     253
};
#endif
...
#line 162 "./src/sgramm.y"
                    {(yyval.num) = (yyvsp[0].num);}
#line 1271 "y.tab.c"
    break;

  case 12: /* $@1: %empty  */
#line 165 "./src/sgramm.y"
                 {slhs = (char *) (yyvsp[0].ref);}
#line 1277 "y.tab.c"
    break;

  case 16: /* alt: seq trans  */
#line 173 "./src/sgramm.y"
      {
	struct srule rule;
	int end_marker = -1;
...
#line 1323 "y.tab.c"
  ...
  case 20: /* trans: %empty  */
#line 211 "./src/sgramm.y"
            {(yyval.ref) = NULL;}
#line 1329 "y.tab.c"
    break;

  case 21: /* trans: '#'  */
#line 212 "./src/sgramm.y"
            {(yyval.ref) = NULL;}
#line 1335 "y.tab.c"
    break;

  case 22: /* trans: '#' NUMBER  */
#line 214 "./src/sgramm.y"
        {
